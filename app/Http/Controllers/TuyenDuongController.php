...
class TuyenDuongController extends Controller
{
    ...
    {
        $tuyen_duong = TuyenDuong::where('isdelete',0)->where('tuyen_duong_id',null)->with(['diem_dau_xa','diem_dau_huyen','diem_cuoi_huyen','diem_cuoi_xa','huyen', 'tai_lieu', 'don_vi', 'loai_tuyen_duong','phan_cap','doan_duong','doan_duong.diem_dau_xa','doan_duong.diem_dau_huyen','doan_duong.diem_cuoi_huyen','doan_duong.diem_cuoi_xa','doan_duong.don_vi']);
